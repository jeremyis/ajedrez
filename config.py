...
class GameConfig:
  ...
  BOARD_HEIGHT = 8
  SQUARE_SIZE = 100
  BOARD_DARK_COLOR = "#5F7BD9"
  BOARD_LIGHT_COLOR = "#EFEFEF"
...
class NormalConfig(GameConfig):
  PIECES = (
    ...
    ( PIECES.KING,   TEAMS.WHITE, 'e1' ),
    ( PIECES.QUEEN,  TEAMS.WHITE, 'd1' ),
    ...
    ( PIECES.KING,   TEAMS.BLACK, 'e8' ),
    ( PIECES.QUEEN,  TEAMS.BLACK, 'd8' ),
